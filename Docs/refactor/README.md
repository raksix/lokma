...
- [REQ-154](REQ-154-tarayici-etkilesim-araclari.md) — The agent can only OPEN a URL: add real page interaction (read / scroll / click / type) via a server-side browser engine, since a cross-origin iframe cannot be scripted from the client — pending
