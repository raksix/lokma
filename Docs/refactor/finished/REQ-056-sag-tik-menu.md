...
- **Status:** done 2026-09-08 — commit 9bdc90a (shared `ui/context-menu.tsx` + right-click on sessions/files/pane-tabs/agents/bots/terminals/providers; tsc 0, web+concept builds green, 283 probe tests pass, live bundle byte-identical).
