...
- [REQ-149](finished/REQ-149-sessionlar-websocket-canli.md) — Sessions bound to the websocket: list + transcript requested and pushed over WS instead of the 4 s REST poll — done (live 10/10 ws-push probe + 4/4 browser poll-gate probe)
