...
/**
 * Build a stored ZIP bundle (artifact.html + manifest + DESIGN.md).
 * Python `zipfile`, `unzip` and browsers all read stored entries.
 */
export function buildStoredZip(files: { name: string; content: string }[]): Buffer {
