...
- [REQ-118](finished/REQ-118-spark-native-tools.md) — Spark native tool calling (Responses function_call) — done (FAZ A + FAZ B.1 native chunk + FAZ B.2 function_call_output results + honest 403/429 mapping; live spark blocked: no upstream credits; loop closed 2026-09-13, cron paused)
